...
const Testimonal = () => {
    ...
    return (
        <> 
        <div id="Testimonial" className="flex flex-col items-center my-20 scroll-mt-20">
            ...
            <Title title="Dont just take our words" description=" What our users say about us, we are always looking for improvement and feedbacks if you have a positive experience with us leave a Review ." />
        </div>
