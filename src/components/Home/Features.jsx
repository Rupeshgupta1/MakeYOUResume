...
const Features = () => {
    ...
    return (
        <div id="features" className="flex flex-col items-center my-20 scroll-mt-20">
            ...
            <Title title="Build Resume" description="Discover the tools that make your resume building effortless and efficient." />
